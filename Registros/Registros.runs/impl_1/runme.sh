...
HD_PWD='D:/Arqui/Registros/Registros.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Registros.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Registros.tcl -notrace
