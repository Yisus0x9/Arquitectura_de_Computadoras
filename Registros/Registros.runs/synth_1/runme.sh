...
HD_PWD='D:/Arqui/Registros/Registros.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Registros.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Registros.tcl
