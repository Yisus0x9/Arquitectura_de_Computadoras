...
HD_PWD='C:/Programas_escom/Arrqui/memoria/memoria.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memoria.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memoria.tcl
