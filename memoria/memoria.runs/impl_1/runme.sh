...
HD_PWD='C:/Programas_escom/Arrqui/memoria/memoria.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log memoria.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source memoria.tcl -notrace
