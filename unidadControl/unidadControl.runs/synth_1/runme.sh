...
HD_PWD='C:/Programas_escom/Arrqui/unidadControl/unidadControl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log unidadControl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source unidadControl.tcl
