...
HD_PWD='C:/Programas_escom/Arrqui/unidadControl/unidadControl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log unidadControl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source unidadControl.tcl -notrace
